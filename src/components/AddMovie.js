      ...
      <div className="add-movie users">
        ...
        <div className={`add-movie-form ${myAlert ? "blur-background" : ""}`}>
          ...
          <div className="new-movie-data">
            ...
            {/* DESCRIPTION */}
            <p style={{ width: "fit-content", fontSize: "18px" }}>
              Description:
            </p>
            <textarea
              style={{
        ...
        <button className="button-85 add-movie-button" onClick={handleAddMovie}>
          Add movie
        </button>
      </div>
      {myAlert && (
        <Alert message={"Sorry, the system could not save the movie."} />
      )}
      {successDelete && (
        <Success
