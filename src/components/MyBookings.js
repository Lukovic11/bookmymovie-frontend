  ...
  return (
    <div className="screenings">
      ...
      {loading ? (
        ...
        <div>
          <div
            className={`booking-list movie-list ${
            ...
            {bookings.map((booking) => (
              <div className="movie-item" key={booking.id}>
                <div className="flex-bookings">
                  {booking.screening.movie.poster && (
                    <img
                  ...
                  <div className="details-bookings">
                    <p>
                      Movie:{" "}
                      <Link to={"/movies/" + `${booking.screening.movie.id}`}>
      ...
      {myAlertGet && (
        <Alert message={"Sorry, the system could not load your bookings."} />
      )}
      {myAlertDelete && (
        <Alert message={"Sorry, the system could not delete the booking."} />
      )}
      {successDelete && (
        <Success
